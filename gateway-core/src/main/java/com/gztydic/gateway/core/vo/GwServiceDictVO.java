...
/**
 * GwModelFieldDictId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class GwServiceDictVO implements java.io.Serializable {
	...
	/** default constructor */
	public GwServiceDictVO() {
	}

	/** minimal constructor */
	public GwServiceDictVO(String dictCode, String dictName, String dictKey,
			String dictValue) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwServiceDictVO))
			return false;
		GwServiceDictVO castOther = (GwServiceDictVO) other;
