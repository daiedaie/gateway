...
<script>	
	function addNotice(){
		...
		if(check()){
			...
			$("#addNoticeBtn,#addingNoticeBtn").toggle();
...
<div class="main_title">
	...
	<form method="post" action="system/notice_saveNotice.do">
		...
		<table width="100%" border="0" cellspacing="10px">
			<tr>
				<th>公告标题：</th>
				<td><input name="notice.noticeTitle" id="noticeTitle" type="text" /><span class="c_red">*</span>
				</td>
			</tr>
			<tr>
				<th valign="top">公告内容：</th>
				<td>
<!-- 					<textarea rows="10" cols="30" style="width:500px;height:200px" name="notice.noticeContent" id="noticeContent"></textarea><span class="c_red">*</span> -->
			...
			<tr>
				...
				<td>
					...
					<input name="addNoticeBtn" id="addNoticeBtn" type="button" value="确定" onclick="addNotice()"/>
					<input name="addingNoticeBtn" id="addingNoticeBtn" type="button" value="正在保存" style="display:none;color:gray" disabled/>
