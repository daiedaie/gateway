...
<title>已办列表</title>
  ...
  <form id="searchForm" action="system/workPlan_searchWorkPlanByParam.do" method="post" loadContainer="pageDataList">
	...
	<table width="100%" border="0">
	  ...
	  <c:forEach var="m" items="${pageObject.data }" varStatus="vs">
  	     <tr ${vs.index % 2 == 1? "class='list_bg'" : "" }>
		    ...
		    <td>
		    	<a href="system/workPlan_searchWorkPlanDetail.do?planId=${m.planId }&source=1">查看</a>
		    </td>
		 </tr>
	  </c:forEach>
