...
<title>用户取数申请通过</title>
  ...
  <body class="FrameMain">
	...
	<form id="verifyForm" name="verifyForm" action="system/workPlan_enSureFetchApplySuccess.do" >
	<input type="hidden" name="planId" value="${workPlan.planId}"></input>
